...
2. Run the setup script. It will install Python via winget if missing, create the venv, and install dependencies:
...
Each run script will auto-call `setup_env.bat` the first time if the venv is missing.
